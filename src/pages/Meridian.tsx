    ...
    { n: '3', t: 'Qualitative Interviews', b: '14 qualitative interview sessions with a mix developers and applications owners.' },
        ...
        <section className="px-4 sm:px-8 md:px-14 py-16 md:py-[90px]">
          ...
          <div className={`${contentWidth} grid grid-cols-1 gap-5 md:gap-6`}>
            ...
            <Reveal delay={0.06}>
              <h3 className="mt-[60px] mb-4 text-body-18" style={{ color: '#0f0f0e', fontWeight: 500 }}>Navigation from Databases Overview to Database Service Page</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                >
                  <div className="flex-1 min-w-0 text-left md:text-right">
                    ...
                    <p className="mt-2 ml-0 md:ml-auto" style={{ color: 'rgb(89, 89, 88)', fontSize: 14, fontWeight: 300, lineHeight: '24px', maxWidth: 520 }}>Bath &amp; Body Works needed to enhance payment options to support digital wallets.</p>
                  </div>
                </Link>
              </div>
            </div>
