...
function CaseStudyTopBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-40 flex items-center px-5 sm:px-8 md:px-9 bg-white"
      ...
      <Link to="/work/family-banking" className="flex items-center gap-[10px] ml-auto" style={{ textDecoration: 'none' }}>
          ...
          <div className={contentWidth}>
            ...
            <Reveal delay={0.08}>
              <div className="mt-10 md:mt-[70px] grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
                <div className="md:col-span-2 rounded-[20px] overflow-hidden bg-white flex items-center justify-center p-4 md:p-6" style={{ border: '1px solid rgba(15,15,14,0.08)' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                >
                  <div className="flex-1 min-w-0 text-right">
                    ...
                    <p className="mt-2 ml-auto" style={{ color: 'rgb(89, 89, 88)', fontSize: 14, fontWeight: 300, lineHeight: '24px', maxWidth: 520 }}>Delivering customer-focused outcomes through transformation and replatform.</p>
                  </div>
                </Link>
              </div>
            </div>
