              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                >
                  <div className="flex-1 min-w-0 text-left md:text-right">
                    ...
                    <p className="mt-2 ml-0 md:ml-auto" style={{ color: 'rgb(89, 89, 88)', fontSize: 14, fontWeight: 300, lineHeight: '24px', maxWidth: 520 }}>A scalable enterprise platform that standardized database onboarding, provisioning, and service management.</p>
                  </div>
                </Link>
              </div>
            </div>
